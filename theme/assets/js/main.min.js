...
;// CONCATENATED MODULE: ./src/scripts/inc/smoothScroll.js
...
;// CONCATENATED MODULE: ./src/scripts/inc/webFont.js
/* harmony default export */ function webFont() {
  /**
   * Web Font Loader
   */
  (function ($) {
...
var ScrollMagic = __webpack_require__(306);
var ScrollMagic_default = /*#__PURE__*/__webpack_require__.n(ScrollMagic);
...
/* harmony default export */ function scrollFire() {
  ...
  (function ($) {
    ...
    // init controller
    var controller = new (ScrollMagic_default()).Controller(); // すべての[data-scroll]属性が付いている要素が見えたらクラスを付与
    // 参考: https://scrollmagic.io/examples/basic/reveal_on_scroll.html

    $('[data-scroll]').each(function () {
      // クラス名で処理を変更するために値を取得
      var attrClass = $(this).attr('class'); // トリガーとなるブラウザ下部からの距離（0.9 = 90%）

      var triggerHookValue = 1; // トリガーが終了となる要素の上部からの距離
      // 要素の高さを指定することで、要素が見えている間は常にenter状態になる

      var durationValue = $(this).innerHeight(); // トリガーとなる要素の上部からの距離

      var offsetValue = 0; // ScrollMagic用のシーンを生成
...
;// CONCATENATED MODULE: ./src/scripts/inc/mainVisual.js
function mainVisual() {
  /**
   * Smooth Scroll
   */
...
smoothScroll(); // Web Font Loader

webFont(); // Scroll Magicによるスクロール管理

scrollFire(); // タッチデバイス対応（ホバー挙動の再現など）

touchDevice(); // メインビジュアル動画
